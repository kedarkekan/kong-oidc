...
function verify_bearer_jwt(oidcConfig)
  ...
  local discovery_doc, discovery_err = require("resty.openidc").get_discovery_doc(opts)
  ...
  local json, err = require("resty.openidc").bearer_jwt_verify(opts, claim_spec)
  if err then
